    ...
    if (suggestBtn) {
        suggestBtn.addEventListener('click', async () => {
            ...
            try {
                ...
                const finalPicks = scored.filter(a => !exclusions.has(a.mal_id));
        ...
        resultsContainer.addEventListener('click', (event) => {
            ...
            if (watchedBtn || wantBtn) {
                ...
                const animeData = {
                    ...
                    themes: JSON.parse((btn.dataset.themes || "[]").replace(/&quot;/g, '"')),
                    demographics: JSON.parse((btn.dataset.demographics || "[]").replace(/&quot;/g, '"'))
                };
